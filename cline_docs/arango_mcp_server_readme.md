...
This is a TypeScript-based MCP server that provides database interaction capabilities through ArangoDB. It implements core database operations and allows seamless integration with ArangoDB through MCP tools. You can use it with Claude app and also extension for VSCode that works with mcp like Cline!
...
#### Usage with Cline VSCode extension
